...
public class JolokiaMBeanServerHandlerTest {
    ...
    @Test
    public void simple() throws NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanException, MalformedObjectNameException, AttributeNotFoundException, ReflectionException, InstanceNotFoundException, JSONException, InvalidTargetObjectTypeException, NoSuchMethodException, IntrospectionException {
        ...
        server.registerMBean(new JsonAnnoTest(),oName);
            ...
            JSONObject chiliJ = JSONAware.parse(new StringReader(chiliS)).getObject();
    ...
    @Test
    public void withConstraint() throws MalformedObjectNameException, NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanException, AttributeNotFoundException, ReflectionException, InstanceNotFoundException, JSONException {
        MBeanServer server = createJolokiaMBeanServer();
        ...
        JSONObject deepDiveS = JSONAware.parse(new StringReader(deepDive)).getObject();
        assertEquals(deepDiveS.length(),1);
