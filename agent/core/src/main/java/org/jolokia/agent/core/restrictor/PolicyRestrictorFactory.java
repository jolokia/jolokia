package org.jolokia.agent.core.restrictor;
...
public final class PolicyRestrictorFactory {
     ...
     * is looked up (with the URL given by the init parameter {@link org.jolokia.agent.core.config.ConfigKey#POLICY_LOCATION}
