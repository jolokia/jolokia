...
import org.jolokia.util.ServletUtil;
...
public class AgentServletTest {
    ...
    public void initWithCustomLogHandler() throws Exception {
        ...
        ServletUtil.prepareServletConfigMock(config, new String[]{ConfigKey.LOGHANDLER_CLASS.getKeyValue(), CustomLogHandler.class.getName()});
        ServletUtil.prepareServletContextMock(context,null);
    ...
    private void initConfigMocks(String[] pInitParams, String[] pContextParams,String pLogRegexp, Class<? extends Exception> pExceptionClass) {
        ...
        ServletUtil.prepareServletConfigMock(config,params);
        ServletUtil.prepareServletContextMock(context, pContextParams);
    ...
    private void preparePostRequest(String pReq) throws IOException {
        ServletInputStream is = ServletUtil.createServletInputStream(pReq);
