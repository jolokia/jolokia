...
public class JCAConnectionPoolStatsSimplifier<T extends JCAConnectionPoolStats>
		extends JCAConnectionStatsSimplifier<T> {
	protected JCAConnectionPoolStatsSimplifier(Class<T> type) {
		super(type);
	...
	public JCAConnectionPoolStatsSimplifier() {
		this((Class<T>) JCAConnectionPoolStats.class);
	}
}
