...
public class MessageDrivenBeanStatsSimplifier<T extends MessageDrivenBeanStats>
		extends EJBStatsSimplifier<T> {
	protected MessageDrivenBeanStatsSimplifier(Class<T> type) {
		super(type);
	...
	public MessageDrivenBeanStatsSimplifier() {
		this((Class<T>) MessageDrivenBeanStats.class);
	}
}
