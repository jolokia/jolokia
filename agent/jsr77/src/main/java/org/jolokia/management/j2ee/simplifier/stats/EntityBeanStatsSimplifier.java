...
public class EntityBeanStatsSimplifier<T extends EntityBeanStats> extends
		EJBStatsSimplifier<T> {
	protected EntityBeanStatsSimplifier(Class<T> type) {
		super(type);
	...
	public EntityBeanStatsSimplifier() {
		this((Class<T>) EntityBeanStats.class);
	}
}
