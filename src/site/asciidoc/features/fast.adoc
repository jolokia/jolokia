...
Jolokia uses the https://code.google.com/archive/p/json-simple/wikis/PerformanceTesting.wiki[super fast,role=externalLink,window=_blank] JSON serialization
