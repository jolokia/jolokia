...
https://www.jquery.com[jQuery]. A typical setup in an HTML page
...
integration testing. It contains https://qunitjs.com/[QUnit] based tests that run within a browser. The
