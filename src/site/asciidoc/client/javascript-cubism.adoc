...
https://d3js.org/[d3.js,role=externalLink]. It provides support for
...
chart,role=externalLink]. The activity of the two garbage collectors for
...
https://jolokia.org/jolokia[Jolokia agent,role=externalLink] and the
href="https://labs.consol.de/jenkins[Jenkins CI server,role=externalLink]. Since this demo queries the Jolokia
