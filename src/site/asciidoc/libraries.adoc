...
* https://github.com/jolokia/jolokia/tree/v1.7.2/agent[agent modules,role=externalLink]
* https://github.com/jolokia/jolokia/tree/v1.7.2/client[client modules,role=externalLink]
...
|`jolokia-spring`
|Spring agent that extends `jolokia-jvm` by adding https://spring.io/projects/spring-framework[Spring Framework,role=externalLink] integration (e.g., dedicated https://docs.spring.io/spring-framework/docs/3.2.1.RELEASE/spring-framework-reference/html/extensible-xml.html[Spring XML namespace handler,role=externalLink])

|`jolokia-osgi`
|OSGi agent that uses https://docs.osgi.org/specification/osgi.cmpn/7.0.0/service.http.html[OSGi CMPN Http Service,role=externalLink] API to register Jolokia Agent Servlet within OSGi runtime

|`jolokia-osgi-bundle`
|OSGi agent which is packaged with https://github.com/apache/felix-dev/tree/master/http[Felix HTTP service,role=externalLink]
...
* https://github.com/jolokia/jolokia/tree/2.0/server[server modules,role=externalLink]
* https://github.com/jolokia/jolokia/tree/2.0/service[service modules,role=externalLink]
* https://github.com/jolokia/jolokia/tree/2.0/agent[agent modules,role=externalLink]
* https://github.com/jolokia/jolokia/tree/2.0/client[client modules,role=externalLink]
* https://github.com/jolokia/jolokia/tree/2.0/support[support modules,role=externalLink]
...
|`jolokia-agent-osgi`
|OSGi agent that uses https://docs.osgi.org/specification/osgi.cmpn/8.1.0/service.servlet.html[OSGi CMPN Whiteboard Specification for Jakarta™ Servlet,role=externalLink] to register Jolokia Agent Servlet within OSGi runtime
