...
The slides to my talk for the small but very fine link:https://www.jayday.de[JayDay 2013,role=externalLink,window=_blank] are
link:https://ro14nd.de/talks/2013/jayday-javascript-jmx/index.html[online,role=externalLink,window=_blank].
...
bottom of a link:https://ro14nd.de/talks/2013/jayday-javascript-jmx/index.html#/step-20[demo slide,role=externalLink,window=_blank].
...
available on link:https://www.parleys.com[Parleys,role=externalLink,window=_blank]. Well, as explained
https://labs.consol.de/lang/de/blog/devoxx/devoxx-2011-day-1/#jolokia[here,role=externalLink,window=_blank] I was quite nervous on my first Devoxx
...
The slides with included videos are also available at link:https://www.slideshare.net/roland.huss/jolokia-devoxx[Slideshare,role=externalLink,window=_blank]:
...
This link:https://www.netways.de/index.php?id=3031&L=1[talk,role=externalLink,window=_blank]
from the link:https://www.netways.de/en/osmc/y2011/overview/[Open Source Monitoring Conference,role=externalLink,window=_blank]
