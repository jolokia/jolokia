...
The best place to get Jolokia support is the https://github.com/jolokia/jolokia/discussions[GitHub discussions page,role=externalLink,window=_blank] or https://github.com/jolokia/jolokia/issues[GitHub issues page,role=externalLink,window=_blank].
...
Jolokia uses
https://github.com/jolokia/jolokia[GitHub,role=externalLink,window=_blank] as source
repository and employs a
https://help.github.com/pull-requests/[Fork + Pull Model,role=externalLink,window=_blank]
...
https://github.com/jolokia/jolokia[project page,role=externalLink,window=_blank]
(use "Fork" from the menu).
* Your contribution must be donated under the https://www.apache.org/licenses/LICENSE-2.0.html[Apache Public License,role=externalLink,window=_blank] and you
should sign-off your commits that you conform to the https://developercertificate.org/[Developer Certificate of Origin,role=externalLink,window=_blank]
...
https://help.github.com/pull-requests[pull request,role=externalLink,window=_blank].
...
licensed under xref:license.adoc[Apache License] Version 2 and you must sign-off the contribution (see above).
...
software you can https://www.flattr.com[flattr,role=externalLink,window=_blank] it.
