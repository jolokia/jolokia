...
The best place to get Jolokia support is the https://github.com/jolokia/jolokia/issues[GitHub,role=externalLink] page where Jolokia is being developed. You can ask questions and report issues directly and simply as GitHub issues and you'll find developers from different time zones ready to answer your questions.
