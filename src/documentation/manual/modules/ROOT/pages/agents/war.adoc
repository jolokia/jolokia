...
****
https://metacpan.org/dist/jmx4perl[jmx4perl] comes
with a nice command line utility called
https://metacpan.org/dist/jmx4perl/view/scripts/jolokia[jolokia]
which allows for an easy setup of security within a given
`jolokia.war`. See xref:tools.adoc#tools-jmx4perl[] for
more details.
****
