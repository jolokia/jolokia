...
* Jolokia's `remote-jmx-adapter-{jolokia-version}-standalone.jar`
...
`jolokia-kubernetes-{jolokia-version}-standalone.jar`
...
[,bash,subs="attributes,verbatim"]
----
java \
  -classpath "jolokia-jmx-adapter-{jolokia-version}-standalone.jar:\
              jolokia-kubernetes-{jolokia-version}-standalone.jar:\
