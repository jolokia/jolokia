...
https://en.wikipedia.org/wiki/Representational_State_Transfer[REST,role=externalLink]
...
Before proceeding, let's review some important concepts from https://jakarta.ee/specifications/servlet/5.0/jakarta-servlet-spec-5.0[Jakarta Servlet Specification 5,role=externalLink].

https://jakarta.ee/specifications/servlet/5.0/jakarta-servlet-spec-5.0#request-path-elements[Chapter 3.5. Request Path Elements,role=externalLink] splits full URI used to access Java Servlet container into three parts (query string is not included here):
...
in https://www.json.org[JSON,role=externalLink], a
...
https://en.wikipedia.org/wiki/List_of_HTTP_status_codes[this page,role=externalLink]
...
`400 .. 499` or `500 .. 599`
https://en.wikipedia.org/wiki/List_of_HTTP_status_codes[as it is specified for HTTP return codes,role=externalLink].
...
https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/MXBean.html[MXBean,role=externalLink]
...
The https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/MXBean.html[MXBean Framework,role=externalLink] is available in
...
https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/MXBean.html[specification,role=externalLink].
...
We can use a tool like https://nmap.org/ncat/[netcat,role=externalLink] to check the discovery:
