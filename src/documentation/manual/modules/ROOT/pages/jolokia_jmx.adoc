...
MBeans,role=externalLink] are used. However, for Spring users there is even a
easier, more
https://docs.spring.io/spring-framework/reference/integration/jmx/exporting.html[declarative
way,role=externalLink] for turning POJOs into MBeans. On top of this Jolokia
...
JMX 1.4 introduced
https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/MXBean.html[MXBeans,role=externalLink]
...
https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/openmbean/CompositeData.html[`CompositeData`,role=externalLink]
...
JMX,role=externalLink] uses a ModelMBean for
