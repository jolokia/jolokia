...
https://github.com/rhuss/jolokia/blob/master/it/war/src/main/webapp/WEB-INF/jboss-deployment-structure.xml[integration test war], the location
...
JVM since 1.5.footnote:jbos-mxbean[
...
``ModelMBean``'s unde the hood. E.g.
