...
WARNING: Remember https://en.wikipedia.org/wiki/Log4Shell[Log4Shell]? It was _all_ about forcing an application to fetch an LDAP record containing `javaSerializedData` attribute and deserialize it with catastrophic consequences. +
