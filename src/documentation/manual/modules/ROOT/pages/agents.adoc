...
used to come in two flavors (with and without packaged https://github.com/apache/felix-dev/tree/master/http[Felix HTTP Service,role=externalLink] bundles). With Jolokia 2 there's only one bundle
