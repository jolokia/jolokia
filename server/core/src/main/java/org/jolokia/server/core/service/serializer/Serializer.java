 ...
 * is still connected to <em>org.json/json</em>, but this dependency might be removed in
 * the future.
 *
 * @author roland
 * @since 02.10.13
...
public interface Serializer extends JolokiaService<Serializer> {
     ...
     * an {@link org.jolokia.server.core.util.JSONAware} object or its string representation.
     *
