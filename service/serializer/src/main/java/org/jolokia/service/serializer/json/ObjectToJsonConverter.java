...
public final class ObjectToJsonConverter {
    ...
    public ObjectToJsonConverter(StringToObjectConverter pStringToObjectConverter) {
        ...
        handlers.add(new JSONArrayExtractor());
        handlers.add(new MapExtractor());
        handlers.add(new JSONObjectExtractor());
     ...
     * @return the converter object. This either a subclass of {@link org.jolokia.server.core.util.JSONAware} or a basic data type like String or Long.
     ...
     * @param pJsonify whether a JSON representation {@link org.json.JSONObject}
     * @return extracted object either in native format or as {@link org.json.JSONObject}
