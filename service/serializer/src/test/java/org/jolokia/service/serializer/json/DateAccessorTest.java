...
public class DateAccessorTest {
    ...
    public void customFormatExtract() throws AttributeNotFoundException {
        extractor = new DateAccessor(new DateFormatConfiguration("yyyyMMddHHmmssSSS", TimeZone.getDefault()));
    ...
    public void formatSet() throws InvocationTargetException, IllegalAccessException {
        {
            extractor = new DateAccessor(new DateFormatConfiguration("yyyyMMddHHmmssSSS", TimeZone.getTimeZone("UTC")));
            Date date = new Date();
        ...
        {
            extractor = new DateAccessor(new DateFormatConfiguration("yyyyMMddHHmmssSSS", TimeZone.getTimeZone("CET")));
            Date date = new Date();
            SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmssSSS");
            // this is the same as the one used by the extractor
