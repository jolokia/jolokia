...
mvn -Dmaven.repo.local=/tmp/repo \
    -DdevelopmentVersion=2.3.0-SNAPSHOT \
...
# copy changed site
grep -lr 2.3.0-SNAPSHOT | xargs sed -i 's/2.3.0-SNAPSHOT/2.2.9/g'
git add .
...
6. `mvn -Dmaven.repo.local=/tmp/repo -DdevelopmentVersion=2.3.0-SNAPSHOT -DreleaseVersion=2.2.9 -Dtag=v2.2.9 -Pdist release:prepare`
