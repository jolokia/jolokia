...
mvn -Dmaven.repo.local=/tmp/repo \
    -DdevelopmentVersion=2.2.8-SNAPSHOT \
    -DreleaseVersion=2.2.7 \
    -Dtag=v2.2.7 \
...
# copy changed site
grep -lr 2.2.8-SNAPSHOT | xargs sed -i 's/2.2.8-SNAPSHOT/2.2.7/g'
git add .
...
6. `mvn -Dmaven.repo.local=/tmp/repo -DdevelopmentVersion=2.2.8-SNAPSHOT -DreleaseVersion=2.2.7 -Dtag=v2.2.7 -Pdist release:prepare`
