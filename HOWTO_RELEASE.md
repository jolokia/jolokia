...
mvn -Dmaven.repo.local=/tmp/repo \
    -DdevelopmentVersion=2.4.4-SNAPSHOT \
    -DreleaseVersion=2.4.3 \
    -Dtag=v2.4.3 \
...
# copy changed site
grep -lr 2.4.4-SNAPSHOT | xargs sed -i 's/2.4.4-SNAPSHOT/2.4.3/g'
git add .
...
6. `mvn -Dmaven.repo.local=/tmp/repo -DdevelopmentVersion=2.4.4-SNAPSHOT -DreleaseVersion=2.4.3 -Dtag=v2.4.3 -Pdist release:prepare`
