 ...
 * {@link org.jolokia.converter.json.ObjectToJsonConverter}
 *
 * @author roland
 * @since 28.09.11
 */
class SimpleTypeConverter extends OpenTypeConverter<SimpleType<?>> {
    ...
    private final org.jolokia.converter.object.Converter<String> objectToObjectConverter;
     ...
     */
    SimpleTypeConverter(ObjectToOpenTypeConverter pObjectToOpenTypeConverter, org.jolokia.converter.object.Converter<String> pObjectToObjectConverter) {
