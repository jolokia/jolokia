...
public class ClassUtilTest {
    ...
    public void classForNameFoundInParent() throws ClassNotFoundException {
        ...
        Class clazz = ClassUtil.classForName("org.jolokia.core.util.RequestType");
        assertEquals(clazz.getName(),"org.jolokia.core.util.RequestType");
        assertEquals(oldCl.loadClass("org.jolokia.core.util.RequestType"),clazz);
